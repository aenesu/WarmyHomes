...
export default function RandomProp() {
  ...
  const advert = {
    ...
    desc: `Göksu ile Küçüksu dereleri arasında kalan çayırlık alan, Osmanlı döneminde padisahların Boğaziçi'ndeki hasbahçelerinden, zamanla da en gözde mesire yerlerinden biri olarak tanınmaktadır. <br/><br/>
            17. yüzyılda ünlü seyyah Evliyâ Çelebi, “bir âb-ı hayât nehirdir” diye bahsettiği Göksu'yu, üzerinde kayıklarla dolasılan; etrafı gül bahçeleri, küçük köskler ve hazineye ait değirmenlerle çevrili sakin bir yer olarak tasvir etmistir. Sultan IV. Murad (1623-1640), Kandilli'ye kadar sık selvi ağaçlarıyla kaplı Küçüksu ve çevresini düzenlettirerek buraya “Gümüs Selvi” adını vermistir.<br/><br/>
            Hasbahçe içindeki ilk yapılasma Sultan I. Mahmud (1730-1754) döneminde baslamıstır. Göksu'da sık sık avlanan ve atıs talimleri yapan Sultan için Sadrazam Divitdâr Mehmed Emin Pasa, 1751-1752 yıllarında ahsap bir kösk yaptırmıstır. Deniz kıyısındaki bu iki katlı yapı, Sultan III. Selim (1789-1807) döneminde genis çaplı bir onarımdan geçmis ve Sultan'ın isteği üzerine çok sevdiği annesi Mihrisah Valide Sultan adına 1806'da bir de çesme eklenmistir. Sultan II. Mahmud (1808-1839) döneminde de kullanılmaya devam eden eski kösk, Sultan Abdülmecid (1839-1861) tarafından yıktırılmıs ve yerine 1856-1857 yıllarında yeni Küçüksu Kasrı yaptırılmıstır. Sultan Abdülaziz (1861-1876) döneminde, kasrın cephe süslemeleri elden geçirilerek zenginlestirilmistir.`,
